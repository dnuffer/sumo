...
#pragma config(Sensor, dgtl3,  spareButton1,   sensorNone)
#pragma config(Sensor, dgtl4,  spareButton2,   sensorNone)
#pragma config(Sensor, dgtl9,  ultrasonicEncoder, sensorQuadEncoder)
#pragma config(Sensor, dgtl11, ultrasonic,     sensorSONAR_mm)
#pragma config(Sensor, I2C_1,  leftWheelEncoder, sensorSpare2OnI2CPort,         , 0)
#pragma config(Sensor, I2C_2,  rightWheelEncoder, sensorSpare3OnI2CPort,         , 0)
#pragma config(Motor,  port1,           sonar_rotate,  tmotorVex393, openLoop)
...
#pragma config(Motor,  port4,           centerLeft,    tmotorVex393HighSpeed, openLoop, reversed)
#pragma config(Motor,  port5,           centerRight,   tmotorVex393, openLoop)
			...
			case Follow_Closest_Object:
				...
				if (degrees_to_turn < 360/SONAR_BINS)
				{
					...
					move_motor_to_position(centerRight,
						nMotorEncoder[centerRight] + RIGHT_MOTOR_ENCODING_TICKS_PER_DEGREE * degrees_to_turn,
				...
				else if (degrees_to_turn > 360/SONAR_BINS)
				{
					...
					move_motor_to_position(centerLeft,
						nMotorEncoder[centerLeft] + LEFT_MOTOR_ENCODING_TICKS_PER_DEGREE * degrees_to_turn,
						&left_pid_controller);
					//turn_right();
				}
				else
